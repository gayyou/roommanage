    ...
    <div class="edit-package-container">
      ...
      <div class="item-container">
        <div class="half-section">
          ...
          <InputNumber :max="5000" v-model="localMoney" style="margin-left: 0.2rem;width: 2.2rem"></InputNumber>
        </div>
        <div class="half-section">
          <span class="item-key" style="margin-top: .05rem">套餐天数</span>
          <InputNumber :max="1000" :min="1" v-model="localDays" style="margin-left: 0.2rem;width: 2.2rem"></InputNumber>
        </div>
      </div>
